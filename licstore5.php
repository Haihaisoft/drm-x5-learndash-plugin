<?php
// DRM-X 5.0 license endpoint for WordPress and LearnDash.
...
if (!class_exists('DRMX5_LD_License_Controller')) {
    wp_die(
        esc_html__('The DRM-X 5.0 LearnDash integration plugin is not active.', 'drmx5-learndash'),
        esc_html__('Unable to obtain DRM-X license', 'drmx5-learndash'),
        array('response' => 503)
    );
}

DRMX5_LD_License_Controller::handle();
